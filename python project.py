...
Label(window, text="welcome to Python Bank:", width=100, bg='yellow', font = 'none 14 bold').grid(row=1, column=0)

Label(window, text="Choose any option:", width=100, bg='green', font = 'none 14 bold').grid(row=2, column=0)

def account():
    acco = Tk()

    acco.title("open account")
    Label(acco, text="Fill your details to create a new acoount:", width=100, bg='yellow', font = 'none 14 bold').grid(row=0, column=0)
    Label(acco, text="name:", width=50, bg='gray',font = 'none 14 bold').grid(row=1, column=0)
    Label(acco, text="age:", width=50, bg='gray',font = 'none 14 bold').grid(row=2, column=0)
    Label(acco, text="addr:", width=50, bg='gray',font = 'none 14 bold').grid(row=3, column=0)
    Label(acco, text="gender:", width=50, bg='gray',font = 'none 14 bold').grid(row=4, column=0)
    Label(acco, text="amount:", width=50, bg='gray',font = 'none 14 bold').grid(row=5, column=0)
    ...
    Label(acco, text="press button to quit window:", width=35, height=5, bg='gray', font = 'none 14 bold').grid(row=7, column=1)
...
def cash_deposit():
    ...
    Label(cash_d, text="enter your name :", width=50, bg='gray',font = 'none 14 bold').grid(row=0, column=0)
    Label(cash_d, text="enter how much cash you want to deposit:", width=50, bg='gray',font = 'none 14 bold').grid(row=1, column=0)
    ...
    Label(cash_d, text="press button to quit window:", width=35, height=5, bg='gray',font = 'none 14 bold').grid(row=7, column=1)
...
def account_deital():
    ...
    Label(acco_d, text="enter your name :", width=50, bg='green',font = 'none 14 bold').grid(row=0, column=0)
    Label(acco_d, text="information about your account:", width=50, bg='green',font = 'none 14 bold').grid(row=1, column=0)
    ...
    Label(acco_d, text="press button to quit window:", width=35, height=5, bg='gray',font = 'none 14 bold').grid(row=7, column=1)
...
def cash_withdrawal():
        ...
        Label(cash_w, text="enter your name :", width=50, bg='yellow',font = 'none 14 bold').grid(row=0, column=0)
        Label(cash_w, text="enter how much cash you want to withdraw:", width=50, bg='yellow',font = 'none 14 bold').grid(row=1, column=0)
        ...
        Label(cash_w, text="press button to quit window:", width=35, height=5, bg='gray',font = 'none 14 bold').grid(row=7, column=1)
...
def stop():
    ...
    Label(st, text="if you want to exit from project press quit button", width=50, bg='white',font = 'none 14 bold').grid(row=0, column=0)
    def quit_p():
        exit()
